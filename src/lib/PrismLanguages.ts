// Auto-generated from prismjs/components.js manifest.
// Imports are ordered to satisfy dependencies (e.g. clike before javascript,
// javascript before typescript, etc.) — do NOT reorder.
// 297 languages total.
